...
def test_release_environment(run_command):
    ...
    # when
    help_result, _ = run_command("fosslight_android -h")
    ok_result, _ = run_command("fosslight_android -b test/binary.txt -n test/NOTICE.html -c ok")
    nok_result, _ = run_command("fosslight_android -b test/binary.txt -n test/NOTICE.html -c nok")
    divide_result, _ = run_command("fosslight_android -d test/needtoadd-notice.html")
